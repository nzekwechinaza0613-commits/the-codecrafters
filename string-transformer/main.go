...
func main() {
	fmt.Println(" ")
	fmt.Println("************* SENTINEL IS ONLINE ****************")
	fmt.Println(" ")

start:
	fmt.Println("AVAILABLE TRANSFORMATIONS; <upper>, <lower>, <cap>, <title>, <snake>, <reverse>")
	fmt.Println(" ")
	fmt.Print("TEXT: ")
	...
	default:
		...
		fmt.Print("THESE ARE THE AVAILABLE COMMANDS;\n 1.upper\n 2.lower\n 3.cap\n 4.title\n 5.snake\n 6.reverse\n")
